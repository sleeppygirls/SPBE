                ...
                <div class="container-fluid back">
                    <div class="row">
                        <div class="col-sm-12 mt-3">
                            {{-- <h1 style="color: white; padding-left: 11px" class="m-0 dashboard fw-bold">Indikator 1</h1> --}}
                        </div>
                        <div style="padding-left: 20px;padding-right: 20px;" class="col-12">
                            <div style="min-height: 2000px; margin-bottom: 5px" class="card">
                                <div class="row" style="margin-top: 20px;">
                                    <table class="table"
                                        style="margin-left: 40px; margin-right: 40px; padding-right: 20px; margin-bottom: 0px;">
                                        <tbody>
                                            <tr>
                                                <td style="background-color: lightgrey; color: grey; text-align: center;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 15px">
                                                            <div class="col-12" id="accordion">
                                                                ...
                                                                <div id="collapse{{ $key + 1 }}" class="collapse"
                                                                    ...
                                                                    {{-- <hr style="margin-bottom: 10px; margin-top: 0px; height: 2px;"> --}}
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div id="radio" class="custom-control custom-radio"
                                                                ...
                                                                @if (Auth::user()->level == 'user')
                                                                    <input
                                                                        ...
                                                                        type="radio" id="customRadio{{ $key + 1 }}"
                                ...
                                <div class="row" style="margin-left: 40px;">
                                    <div class="col-11">
                                        <p style="margin-bottom: 0px; color: lightgrey">Daftar Dokumen Evaluasi Tahun Lalu
                                        </p>
                                        <p style="color: grey">(centang untuk menandai bahwa dokumen tersebut akan digunakan
                                        ...
                                        <p style="margin-top: 25px; margin-bottom: 5px; color: lightgrey;">Daftar Dokumen
                                        </p>
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="exampleInputFile"
                                                    style="color: lightgrey; width: 840px">Unggah satu [pdf] atau banyak
                                                    file
                                                    [zip/rar] *max
                                                    100MB</label>
                                            </div>
                                        ...
                                        <p style="color: red; margin-bottom: 0px;margin-top: 25px;font-size: small">
                                            *panjang
                                            nama file maksimum 60 karakter, jika melebihi 60 karakter, sistem akan otomatis
                                            memotong nama file menjadi 60 karakter</p>
                                        <p style="color: red; font-size: small; margin-bottom: 50px;">*apabila ukuran file
                                            yang
                                            di unggah melebihi ketentuan batas maksimum, agar dapat mereferensikan url/link
                                            data
                                        ...
                                        @endif
                                        <button type="submit" class="btn btn-success" style="margin-left: 690px">Upload
                                            dan
                                            Simpan</button>
                                    </div>
                                </div>
